	...
	function m_shop_setup(){
        ...
        add_theme_support( 'recommend-plugins', array(
            ...
            'woo-smart-wishlist' => array(
                 'name' => esc_html__( 'WPC Smart Wishlist for WooCommerce', 'm-shop' ),
                 'active_filename' => 'woo-smart-wishlist/wpc-smart-wishlist.php',
                 'slug'				=>	'woo-smart-wishlist',
             ),
            'woo-smart-compare' => array(
                 'name' => esc_html__( 'WPC Smart Compare for WooCommerce', 'm-shop' ),
...
function m_shop_scripts(){
    ...
    wp_enqueue_script( 'm-shop-custom-js', M_SHOP_THEME_URI .'/js/m-shop-custom.js', array( 'jquery' ), M_SHOP_THEME_VERSION , true );
     $mshoplocalize = array(
				'm_shop_top_slider_optn' => get_theme_mod('m_shop_top_slider_optn',false),
				'm_shop_move_to_top_optn' => get_theme_mod('m_shop_move_to_top',false),
				'm_shop_sticky_header_effect' => get_theme_mod('m_shop_sticky_header_effect','scrldwmn'),
				'm_shop_slider_speed' => get_theme_mod('m_shop_slider_speed','3000'),
